...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Directorio donde se guardarán los archivos media

STATICFILES_DIRS = [os.path.join(BASE_DIR, 'app/static')]  # Directorio donde están los archivos estáticos
